...
#define __HEADER__
	...
	const color kd=color((GLfloat) 0.1,(GLfloat) 0.1,(GLfloat) 0.1);
	const color ks=color((GLfloat) 0.1,(GLfloat) 0.1,(GLfloat) 0.1);
	const color ka=color((GLfloat) 0.1,(GLfloat) 0.1,(GLfloat) 0.1);
	const color kr=color((GLfloat) 0.1,(GLfloat) 0.1,(GLfloat) 0.1);
